<template>
  <div class="vue-photo-upload">
    <form class="vue-photo-upload-form" @submit.prevent="photo_submit">
      <label for="vue-photo-upload-file-input" style="cursor: pointer">
        <!--<a :class="[buttonClass ? buttonClass : 'vue-photo-upload-btn']">Change Image</a>-->

        <canvas
          v-show="(vue_photo_selected && enableEdits)"
          id="vue-photo-upload-canvas"
          class="rounded-circle m-auto large-profilePicture photo photo-padded"
